...
export default class Counter {
  ...
  createElement() {
    ...
    counterText.appendChild(document.createTextNode("Count is currently..."));
    ...
    iconDecrementText.appendChild(document.createTextNode("Decrement Count"));
    ...
    iconIncrementText.appendChild(document.createTextNode("Increment Count"));
