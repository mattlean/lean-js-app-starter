...
const createFooterText = () => {
  ...
  line1.innerHTML =
    'Learn about the tech stack used for this project and more at its <a href="https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0/examples/counter" class="text-muted">GitHub repo</a>.';
