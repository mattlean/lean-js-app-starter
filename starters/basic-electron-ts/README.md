...
_If you don't need TypeScript, then use the [Basic Electron starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.0.0-rc/starters/basic-electron) instead._
