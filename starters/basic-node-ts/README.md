...
This is a [**Lean JS App Starter (LJAS)**](https://github.com/mattlean/lean-js-app-starter) starter project for a [Node.js](https://nodejs.org) application written in [TypeScript](https://typescriptlang.org).

_If you don't need TypeScript, then then use the [Basic Node.js starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0-rc-20241104/starters/basic-node) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0-rc-20241104/ljas-basic-node-ts_1-0-0.zip) and extract it.
...
For more information on the Docker dev environment, please read the ["Docker Environments" document in the LJAS docs](https://github.com/mattlean/lean-js-app-starter/blob/v1.1.0-rc-20241104/docs/developing/docker-environments.md).
