...
_If you don't need TypeScript, then then use the [Basic Node.js starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0-dev/starters/basic-node) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0-dev/ljas-basic-node-ts_1-0-0.zip) and extract it.
