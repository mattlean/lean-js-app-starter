...
_If you don't need TypeScript, then use the [React + Electron starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.0.0/starters/react-electron) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.0.0/ljas-react-electron-ts_1-0-0.zip) and extract it.
