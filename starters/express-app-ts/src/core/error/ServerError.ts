...
type ServerErrorType = 'auth' | 'misc' | 'notFound' | 'validation'

type ServerErrorErrors = (string | ValidationError)[]

type ServerErrorDevErrors = (string | Error | ValidationError)[]
...
export default class ServerError extends Error {
    ...
    constructor(
        ...
        inputErrs?: string | ValidationError | ServerErrorErrors,
