...
_If you don't need TypeScript, then use the [Basic Browser starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.0.0/starters/basic-browser) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.0.0/ljas-basic-browser-ts_1-0-0.zip) and extract it.
