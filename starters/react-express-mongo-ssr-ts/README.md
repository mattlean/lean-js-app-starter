...
_If you don't need TypeScript, then then use the [React + Express + MongoDB with SSR starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0/starters/react-express-mongo-ssr) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0/ljas-react-express-mongo-ssr-ts_1-0-0.zip) and extract it.
