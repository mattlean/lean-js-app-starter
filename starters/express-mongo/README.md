...
_If you need TypeScript, then use the [Express + MongoDB starter (TypeScript)](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0/starters/express-mongo-ts) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0/ljas-express-mongo_1-0-0.zip) and extract it.
