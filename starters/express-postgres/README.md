...
_If you need TypeScript, then use the [Express + PostgreSQL starter (TypeScript)](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0/starters/express-postgres-ts) instead._
