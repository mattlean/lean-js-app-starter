...
_If you don't need TypeScript, then then use the [Express + MongoDB starter](https://github.com/mattlean/lean-js-app-starter/tree/v1.1.0-rc-20241104/starters/express-mongo) instead._
...
First, [**download the starter project's ZIP file**](https://github.com/mattlean/lean-js-app-starter/releases/download/v1.1.0-rc-20241104/ljas-express-mongo-ts_1-0-0.zip) and extract it.
