...
_If you need TypeScript, then use the [React + Express + PostgreSQL with SSR starter (TypeScript)](https://github.com/mattlean/lean-js-app-starter/tree/master/starters/react-express-postgres-ssr-ts) instead._
